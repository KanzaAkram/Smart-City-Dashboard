...
// import electricityMapRoutes from './routes/electricityMapRoutes.js';
...
// // app.use('/api/waterusage', waterUsageRoutes);
// app.use('/api/energyconsumption', electricityMapRoutes);
