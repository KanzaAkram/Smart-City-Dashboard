    ...
    const handleSubmit = async () => {
        ...
        if (type === 'electricity') {
            requestData = {
                type: 'electricity',
                electricity_unit: electricityUnit,
                electricity_value: parseFloat(electricityValue), // Ensure this is a number
                country,
                state: state || undefined, // Only include if provided
            };
        }  else if (type === 'flight') {
            requestData = {
                type: 'flight',
            ...
            requestData = {
                type: 'shipping',
                weight_value: parseFloat(weightValue), // Convert to float
                weight_unit: weightUnit,
                distance_value: parseFloat(distanceValue), // Convert to float
                distance_unit: distanceUnit,
                transport_method: transportMethod,
            };
        } else if (type === 'vehicle') {
            ...
            requestData = {
                ...
                fuel_source_type: fuelSourceType,
                fuel_source_unit: fuelSourceUnit,
                fuel_source_value: parseFloat(fuelSourceValue), // Convert to float
            };
        }
